...
class SegNet(torch.nn.Module):
    def __init__(self, kernel_size):
        super().__init__()
        self.out_channels = 8 #equal to num features?
        self.bn_input = nn.BatchNorm2d(3) #running mean?
        ...
        self.uc1 = UpConv2(64, 8, kernel_size=kernel_size) #equal to num features
